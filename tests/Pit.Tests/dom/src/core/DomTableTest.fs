...
//
//    member x.CellIndex
//        with get() = x.td.GetProperty<int>("cellIndex")
...
//
//    member x.ColSpan
//        with get() = x.td.GetProperty<int>("colSpan")
...
//
//    member x.RowSpan
//        with get() = x.td.GetProperty<int>("rowSpan")
...
//
//    member x.RowIndex
//        with get() = x.tr.GetProperty<int>("rowIndex")
//        and set(v: int) = x.tr.SetProperty("rowIndex", v)
//
//    member x.SectionRowIndex
//        with get() = x.tr.GetProperty<int>("sectionRowIndex")
