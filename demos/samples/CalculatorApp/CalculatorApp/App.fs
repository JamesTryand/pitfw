// F# Silverlight Compiler services to covert F# to JS

// Sample Source: http://fssnip.net/93
// Online sample link http://trelford.com/PitCalculatorApp.htm

namespace CalculatorApp // Always use a namespace
